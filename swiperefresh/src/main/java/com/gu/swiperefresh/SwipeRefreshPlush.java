...
public class SwipeRefreshPlush extends ViewGroup implements NestedScrollingParent,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!isEnabled() || mReturningToStart || canChildScrollUp()
                || isRefresh || mNestedScrollInProgress) {
    ...
    public void onStopNestedScroll(View target) {
        ...
        if (mTotalUnconsumed > 0) {
            finishPullRefresh(mTotalUnconsumed);
            mTotalUnconsumed = 0;
        }
        stopNestedScroll();
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        LogUtils.d("onNestedScroll"+dyUnconsumed);
        ...
        if (dy < 0 && !canChildScrollUp()) {
            ...
            showPullRefresh(mTotalUnconsumed);
        }
    }
